...
import { getCurrentVolunteers } from '../../../lib/volunteers';

## Current volunteers

<VolunteerGrid volunteers={getCurrentVolunteers()} className="mb-8" />



## Previous volunteers

We also cannot forget the countless volunteers from previous years who have made 
PyCon Malaysia happen annually. 
Their dedication, hard work, and enthusiasm have laid the foundation for what 
PyCon Malaysia is today. 
These volunteers have worked behind the scenes, from organizing logistics to 
welcoming attendees, ensuring that each event runs smoothly and creates lasting 
