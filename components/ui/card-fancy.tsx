...
const Card = React.forwardRef<HTMLDivElement, CardProps>(
  ({ className, variant, title, description, markdownDescription, children, ...props }, ref) => {
    const DotsPattern = () => {
      const sharedClasses =
          ...
          <div className="relative w-full border-x border-zinc-400 dark:border-zinc-700">
            ...
            <div className="relative z-20 mx-auto py-8">
              <CardContent>
                ...
                {description &&
                  (markdownDescription ? (
                    <ReactMarkdown className="prose prose-neutral w-full max-w-none text-gray-700 dark:text-gray-300"
                    >
                      {description}
                    </ReactMarkdown>
                  ) : (
